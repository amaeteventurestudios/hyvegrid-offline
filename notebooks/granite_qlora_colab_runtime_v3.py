# HyveGrid Offline - Granite QLoRA Runtime Script V3
#
...
TRAIN_FILE = "data/finetune/v3/apiculture_v3_train_chat.jsonl"
EVAL_FILE = "data/finetune/v3/apiculture_v3_eval_chat.jsonl"

OUTPUT_DIR = "hyvegrid-granite-lora-v3"
QUICK_EVAL_OUT = "hyvegrid-granite-lora-v3-quick-eval.jsonl"
...
assert count_jsonl(TRAIN_FILE) == 61, "Expected 61 train examples"
assert count_jsonl(EVAL_FILE) == 11, "Expected 11 eval examples"
